...
<head>
    ...
    <style>
        ...
        .stamp {
            ...
            color: rgba(247, 171, 10, 0.5);
            border: 3px solid rgba(247, 171, 10, 0.5);
            border-radius: 10px;
            padding: 10px;
            font-size: 20px;
            font-weight: bold;
    ...
    <div class="container">
        ...
        <div class="notes">
            <div class="payment-info">
                ...
                <div class="payment-details">{{ $facture->mode_paiement ?? 'Virement bancaire' }}</div>
                
                <div class="payment-title">Coordonnées bancaires</div>
                <div class="payment-details">
                    <div>Banque: Wibefoo Financial Services</div>
                    <div>Titulaire: Ezles</div>
        ...
        <div class="footer">
            <p>© Ezles - {{ date('Y') }}</p>
            <p style="margin-top: 5px; font-style: italic;">Ce document constitue une facture officielle conformément aux dispositions du Code Général des Impôts. Document à conserver selon les délais légaux en vigueur.</p>
        </div>

        @if($facture->statut == 'Payée')
        <div class="stamp" style="color: rgba(76, 175, 80, 0.5); border-color: rgba(76, 175, 80, 0.5);">Payé</div>
        @elseif($facture->statut == 'En retard')
        <div class="stamp" style="color: rgba(239, 68, 68, 0.5); border-color: rgba(239, 68, 68, 0.5);">En retard</div>
        @else
        <div class="stamp" style="color: rgba(247, 171, 10, 0.5); border-color: rgba(247, 171, 10, 0.5);">En attente</div>
        @endif
    </div>
</body>
</html> 